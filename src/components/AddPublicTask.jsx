...
function AddPublicTask({ accion }) {
  ...
  return (
    <div className="w-screen h-screen bg-black/50 absolute min-w-screen min-h-screen z-4000">
      <div
        className="mt-4 w-full max-w-4xl rounded-xl p-4 ring-1 ring-slate-200 relative z-5000 top-52 left-60 "
        style={{
